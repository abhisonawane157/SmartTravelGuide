...
//        } else {
        ...
        _spot_child_listener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot _param1, String _param2) {
                ...
                if (_childValue.get("address").toString().contains(file.getString("state", "")) && (_childValue.get("spotcategory").toString().trim().toLowerCase().equals("hill station")))
                {
                    map = new HashMap<>();
...
//            totalstudents.setText("Total Students : ".concat(spotlistmap.get((int)_position).get("totalstudents").toString()));
            ...
            final CardView UI_cardview2 = (CardView) _v.findViewById(R.id.UI_cardview2);
            UI_cardview2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    file.edit().putString("spotid",spotlistmap.get((int)_position).get("spotid").toString()).apply();
