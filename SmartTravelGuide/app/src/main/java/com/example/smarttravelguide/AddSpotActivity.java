...
public class AddSpotActivity extends AppCompatActivity {
    ...
    EditText name,add,id,category, desc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addspot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (name.getText().toString().equals("") && (desc.getText().toString().equals("")) && (add.getText().toString().equals("") && (category.getText().toString().equals("") && id.getText().toString().equals("")))) {
                    ...
                    hashmap.put("spotdesc", desc.getText().toString());
